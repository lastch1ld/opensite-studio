          ...
          <div key={field.id} className="rounded border p-2">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <button onClick={() => moveField(field.id, -1)} disabled={i === 0} className="px-1 text-xs disabled:opacity-30">
                  ↑
                </button>
                <button
                ...
                <button onClick={() => removeField(field.id)} className="px-1 text-xs text-red-600">
                  ✕
                </button>
              </div>
            </div>
